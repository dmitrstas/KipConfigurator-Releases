...
KipConfigurator — это win64 приложение для настройки устройств, работающих по протоколу Modbus. Программа предоставляет интуитивно понятный интерфейс для создания, редактирования и управления конфигурациями, шаблонами и списками значений.
